...
export default function HousingTable({ records, onEdit }) {
      ...
      <table className="table-app table-hover table-striped housing-table">
        <thead>
          <tr>
            ...
            <th className="col-number">Operational<br />Reserves</th>
            <th className="col-number">Replacement<br />Reserves</th>
            <th className="col-number">Current<br />Vacancies</th>
            <th className="col-number">Upcoming<br />Vacancies</th>
            <th className="col-number">Upcoming<br />Leases</th>
        ...
        <tbody>
          {records.map((r) => (
            <tr key={`${r.housing_building_id}-${r.month_date}`}>
              ...
              <td className="col-number">{formatPercent(r.occupancy_percent)}</td>
              ...
              <td className="col-actions">
                <div className="table-actions">
                  ...
                  <button
                    ...
                    onClick={() => handleDelete(r.housing_building_id, r.month_date)}
                  >
                    <FaTrash />
                  </button>
                </div>
