...
export default function ComplianceWeeklyList() {
  ...
  return (
    <div className="hub-container compliance">
      {/* Department Header */}
      <DepartmentHeader
        title="Compliance - Weekly Records"
        actions={
          <>
            <NavLink
              to="/compliance"
      ...
      {/* Toolbar */}
      <div className="compliance-toolbar-container">
        ...
        <div className="compliance-toolbar-right">
          <NavLink to="/compliance/weekly/new" className="btn btn-secondary">
            Add New Record
          </NavLink>
        </div>
      </div>
                  ...
                  <td>
                    <div className="table-actions">
                      <button
                        ...
                        onClick={() =>
                          navigate(`/compliance/weekly/edit/${record.id}`)
                        }
                      >
                        Edit
                      </button>
